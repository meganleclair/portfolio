...
export function ProjectCard({ href, title, description }: ProjectCardProps) {
  return (
    <Link
      href={href}
      className="glass-card group block px-8 py-10 transition-[background-color,border-color] duration-300 ease-out md:px-10 md:py-12 hover:border-black/[0.12] hover:bg-black/[0.04] dark:hover:border-white/[0.12] dark:hover:bg-white/[0.04]"
    >
